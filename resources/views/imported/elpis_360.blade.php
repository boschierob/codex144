...
/* ============================================================
   FLASH SUBLIMINAL
============================================================ */
#flash{position:fixed;top:0;left:0;width:100%;height:100%;background:var(--dark);z-index:9999;display:none;align-items:center;justify-content:center;pointer-events:none}
#flash span{font-family:'Cinzel Decorative',serif;font-size:clamp(4rem,15vw,12rem);color:var(--rouge);letter-spacing:.3em;font-weight:900;text-shadow:0 0 60px var(--rouge),0 0 120px var(--rouge)}
