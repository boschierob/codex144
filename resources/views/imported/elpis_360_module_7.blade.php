...
<meta content="#0A0806" name="theme-color"/>
...
<!-- VUE AGENDA -->
<div class="vue active" id="vue-agenda">
<div id="cal-header">
...
<input class="form-input" id="f-titre" placeholder="Ex : Anniversaire de Marco" type="text"/>
</div>
<div class="form-section">
...
<div><label class="form-label">Heure</label><input class="form-input" id="f-heure" type="time" value="09:00"/></div>
</div>
<div class="form-section">
...
<!-- SÉLECTEUR 12 NOTES -->
<div id="notes-selector" style="display:grid;grid-template-columns:repeat(6,1fr);gap:.4rem;margin-bottom:1.2rem"></div>
<div id="note-active-label" style="font-family:'Cinzel',serif;font-size:.58rem;letter-spacing:.35em;color:var(--rouge);text-transform:uppercase;margin-bottom:.4rem">Note 1</div>
...
<input accept=".ics" class="input-file" id="fi-ics" onchange="importerICS(this)" type="file"/>
...
<input accept=".json" class="input-file" id="fi-json" onchange="importerJSON(this)" type="file"/>
...
<input accept=".csv" class="input-file" id="fi-csv" onchange="importerCSV(this)" type="file"/>
...
<input class="input-file" id="fi-libre" onchange="importerFichierLibre(this)" type="file"/>
<div class="sep"></div>
