...
<style>
  ...
  /* ============================================================
     ...
     TAILLES CORRIGEES V2 (+15% sur toutes les tailles) :

     - Textes corps     : 1.10rem  (était 0.95rem)

     - Noms / labels    : 0.95rem  (était 0.82rem)

     - Labels sections  : 0.87rem  (était 0.75rem)

     - Footer textes    : 1.01rem  (était 0.88rem)

     - Footer latin/url : 0.87rem  (était 0.76rem)

     - Lien retour      : 0.83rem  (était 0.72rem)
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .construction-header { text-align: center; margin-bottom: 50px; opacity: 0; animation: fadeUp 1.4s ease 1.2s forwards; }
  ...
  .lang-text {
    ...
    font-size: clamp(1.10rem, 2vw, 1.25rem);
...
<div class="container">
  ...
  <header class="site-header">
    ...
    <div class="translation-codex" style="color:rgba(242,232,213,0.2);margin-top:0.2rem">« The codex is memory, structure, light, source, knowledge, bond and gate of truth. »</div>
  ...
  <div class="elpis-accroche">
    ...
    <a href="/elpis_360" class="btn-elpis">
  ...
  <footer class="site-footer">
    ...
    <a href="/index_site" class="footer-back">↑ Retour à la page d'accueil CODEX 144</a>
